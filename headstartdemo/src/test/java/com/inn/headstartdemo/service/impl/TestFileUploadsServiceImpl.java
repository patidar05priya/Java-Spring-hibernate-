...
public class TestFileUploadsServiceImpl extends
		AbstractTransactionalTestNGSpringContextTests {

	@BeforeClass
	public void setUpFileUploads() {
		try {
			...
			entity = (FileUploads) JPAUtils.getEntityObj(FileUploads.class);
			Map<String, Map<String, Object>> dbUnitTableMap = JPAUtils
					.getDbUnitDefaultDataSet(FileUploads.class, entity);
	...
	public void tearDownFileUploads() {
		try {
			if (connection != null) {
				connection.close();
			}
    ...
    /**
	 * 
	 *method to create the new testcase of testFileUploads
	 *	
	 */
	@Test(groups = "service", alwaysRun = true)
	public void testFileUploadsCreate() {
		FileUploads actualObject = null;
		FileUploads expectedObject = entity;
		...
		try {
			...
			for (Method method : methods) {
				if (method.getName().equals("findByPk")) {
					actualObject = (FileUploads) 	serviceObj.findById(pk);
				}
			}
    ...
    /**
	 * 
	 *method to update testcase of testFileUploads
	 *	
	 */
	@Test(groups = "service", alwaysRun = true)
	public void testFileUploadsUpdate() {
		FileUploads actualObject = null;
		FileUploads expectedObject = entity;
		Integer pk = entity.getId();
    ...
    /**
	 * 
	 *method to  delete the entity testcase of testFileUploads
	 *	
	 */
	@Test(groups = "service", alwaysRun = true)
	public void testFileUploadsDelete() {
		FileUploads actualObject = null;
		FileUploads expectedObject = null;
		Integer pk = entity.getId();
    ...
    /**
	 * 
	 *method to  delete the entity testcase of testFileUploads  by primary key
	 *@throws Exception
	 */
	@Test(groups = "service", alwaysRun = true)
	public void testFileUploadsDeleteByPk() throws Exception {
		FileUploads actualObject = null;
		FileUploads expectedObject = null;
		Integer pk = entity.getId();
    ...
    /**
	 * 
	 *method to  Find all the testcase of testFileUploads  
	 *
	 */
	@Test(groups = "service", alwaysRun = true)
	public void testFileUploadsFindAll() {
		FileUploads actualObject = null;
		FileUploads expectedObject = entity;
		Integer pk = entity.getId();
    ...
    /**
	 * 
	 *method to  Find the testcase of testFileUploads by primarykey
	 *
	 */
	@Test(groups = "service", alwaysRun = true)
	public void testFileUploadsFindByPk() {
		FileUploads actualObject = null;
		FileUploads expectedObject = entity;
		Integer pk = entity.getId();
	...
	@Autowired
	private IFileUploadsService serviceObj;
	private Method[] methods = null;
	private FileUploads entity = new FileUploads();
	...
	public static Logger logger = LoggerFactory
			.getLogger(TestFileUploadsServiceImpl.class);
}
