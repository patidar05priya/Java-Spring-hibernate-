...
public class TestEmailNotificationsServiceImpl extends
		...
		try {
			...
			for (Method method : methods) {
				if (method.getName().equals("findByPk")) {
					actualObject = (EmailNotifications) 	serviceObj.findById(pk);
				}
			}
    ...
    /**
	 * 
	 *method to  Find the testcase of testEmailNotifications by primarykey
	 *
	 */
	@Test(groups = "service", alwaysRun = true)
	...
	@Autowired
	private IEmailNotificationsService serviceObj;
	...
	public static Logger logger = LoggerFactory
			.getLogger(TestEmailNotificationsServiceImpl.class);
}
