...
public class TestCommentServiceImpl extends
	...
	public void setUpComment() {
		try {
			...
			entity = (Comment) JPAUtils.getEntityObj(Comment.class);
			Map<String, Map<String, Object>> dbUnitTableMap = JPAUtils
					.getDbUnitDefaultDataSet(Comment.class, entity);
    ...
    /**
	 * 
	 *method to create the new testcase of testComment
	 *	
	 */
	@Test(groups = "service", alwaysRun = true)
	public void testCommentCreate() {
		Comment actualObject = null;
		Comment expectedObject = entity;
		...
		try {
			...
			for (Method method : methods) {
				if (method.getName().equals("findByPk")) {
					actualObject = (Comment) 	serviceObj.findById(pk);
				}
			}
    ...
    /**
	 * 
	 *method to update testcase of testComment
	 *	
	 */
	@Test(groups = "service", alwaysRun = true)
    ...
    /**
	 * 
	 *method to  delete the entity testcase of testComment
	 *	
	 */
	@Test(groups = "service", alwaysRun = true)
	public void testCommentDelete() {
		Comment actualObject = null;
		Comment expectedObject = null;
		Long pk = entity.getId();
    ...
    /**
	 * 
	 *method to  delete the entity testcase of testComment  by primary key
	 *@throws Exception
	 */
	@Test(groups = "service", alwaysRun = true)
	public void testCommentDeleteByPk() throws Exception {
		Comment actualObject = null;
		Comment expectedObject = null;
		Long pk = entity.getId();
    ...
    /**
	 * 
	 *method to  Find all the testcase of testComment  
	 *
	 */
	@Test(groups = "service", alwaysRun = true)
    ...
    /**
	 * 
	 *method to  Find the testcase of testComment by primarykey
	 *
	 */
	@Test(groups = "service", alwaysRun = true)
	public void testCommentFindByPk() {
		Comment actualObject = null;
		Comment expectedObject = entity;
		Long pk = entity.getId();
	...
	@Autowired
	private ICommentService serviceObj;
	private Method[] methods = null;
	private Comment entity = new Comment();
	...
	public static Logger logger = LoggerFactory
			.getLogger(TestCommentServiceImpl.class);
}
