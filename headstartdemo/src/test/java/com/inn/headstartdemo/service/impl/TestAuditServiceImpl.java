...
public class TestAuditServiceImpl extends
		...
		try {
			...
			for (Method method : methods) {
				if (method.getName().equals("findByPk")) {
					actualObject = (Audit) 	serviceObj.findById(pk);
				}
			}
    ...
    /**
	 * 
	 *method to  Find the testcase of testAudit by primarykey
	 *
	 */
	@Test(groups = "service", alwaysRun = true)
	...
	@Autowired
	private IAuditService serviceObj;
	...
	public static Logger logger = LoggerFactory
			.getLogger(TestAuditServiceImpl.class);
}
