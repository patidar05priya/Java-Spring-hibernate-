...
public class TestSocialCredentialsServiceImpl extends
		AbstractTransactionalTestNGSpringContextTests {

	@BeforeClass
	public void setUpSocialCredentials() {
		try {
			...
			entity = (SocialCredentials) JPAUtils.getEntityObj(SocialCredentials.class);
			Map<String, Map<String, Object>> dbUnitTableMap = JPAUtils
					.getDbUnitDefaultDataSet(SocialCredentials.class, entity);
	...
	public void tearDownSocialCredentials() {
		try {
			if (connection != null) {
				connection.close();
			}
    ...
    /**
	 * 
	 *method to create the new testcase of testSocialCredentials
	 *	
	 */
	@Test(groups = "service", alwaysRun = true)
	public void testSocialCredentialsCreate() {
		SocialCredentials actualObject = null;
		SocialCredentials expectedObject = entity;
		...
		try {
			...
			for (Method method : methods) {
				if (method.getName().equals("findByPk")) {
					actualObject = (SocialCredentials) 	serviceObj.findById(pk);
				}
			}
    ...
    /**
	 * 
	 *method to update testcase of testSocialCredentials
	 *	
	 */
	@Test(groups = "service", alwaysRun = true)
	public void testSocialCredentialsUpdate() {
		SocialCredentials actualObject = null;
		SocialCredentials expectedObject = entity;
		Integer pk = entity.getId();
    ...
    /**
	 * 
	 *method to  delete the entity testcase of testSocialCredentials
	 *	
	 */
	@Test(groups = "service", alwaysRun = true)
	public void testSocialCredentialsDelete() {
		SocialCredentials actualObject = null;
		SocialCredentials expectedObject = null;
		Integer pk = entity.getId();
    ...
    /**
	 * 
	 *method to  delete the entity testcase of testSocialCredentials  by primary key
	 *@throws Exception
	 */
	@Test(groups = "service", alwaysRun = true)
	public void testSocialCredentialsDeleteByPk() throws Exception {
		SocialCredentials actualObject = null;
		SocialCredentials expectedObject = null;
		Integer pk = entity.getId();
    ...
    /**
	 * 
	 *method to  Find all the testcase of testSocialCredentials  
	 *
	 */
	@Test(groups = "service", alwaysRun = true)
	public void testSocialCredentialsFindAll() {
		SocialCredentials actualObject = null;
		SocialCredentials expectedObject = entity;
		Integer pk = entity.getId();
    ...
    /**
	 * 
	 *method to  Find the testcase of testSocialCredentials by primarykey
	 *
	 */
	@Test(groups = "service", alwaysRun = true)
	public void testSocialCredentialsFindByPk() {
		SocialCredentials actualObject = null;
		SocialCredentials expectedObject = entity;
		Integer pk = entity.getId();
	...
	@Autowired
	private ISocialCredentialsService serviceObj;
	private Method[] methods = null;
	private SocialCredentials entity = new SocialCredentials();
	...
	public static Logger logger = LoggerFactory
			.getLogger(TestSocialCredentialsServiceImpl.class);
}
