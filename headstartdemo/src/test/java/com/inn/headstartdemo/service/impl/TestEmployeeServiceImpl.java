...
public class TestEmployeeServiceImpl extends
		...
		try {
			...
			for (Method method : methods) {
				if (method.getName().equals("findByPk")) {
					actualObject = (Employee) 	serviceObj.findById(pk);
				}
			}
    ...
    /**
	 * 
	 *method to  Find the testcase of testEmployee by primarykey
	 *
	 */
	@Test(groups = "service", alwaysRun = true)
	...
	@Autowired
	private IEmployeeService serviceObj;
	...
	public static Logger logger = LoggerFactory
			.getLogger(TestEmployeeServiceImpl.class);
}
