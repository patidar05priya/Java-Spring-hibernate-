...
public class TestOfficeServiceImpl extends
		...
		try {
			...
			for (Method method : methods) {
				if (method.getName().equals("findByPk")) {
					actualObject = (Office) 	serviceObj.findById(pk);
				}
			}
    ...
    /**
	 * 
	 *method to  Find the testcase of testOffice by primarykey
	 *
	 */
	@Test(groups = "service", alwaysRun = true)
	...
	@Autowired
	private IOfficeService serviceObj;
	...
	public static Logger logger = LoggerFactory
			.getLogger(TestOfficeServiceImpl.class);
}
