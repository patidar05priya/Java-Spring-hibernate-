...
public class TestActivityStreamServiceImpl extends
		AbstractTransactionalTestNGSpringContextTests {

	@BeforeClass
	public void setUpActivityStream() {
		try {
			...
			entity = (ActivityStream) JPAUtils.getEntityObj(ActivityStream.class);
			Map<String, Map<String, Object>> dbUnitTableMap = JPAUtils
					.getDbUnitDefaultDataSet(ActivityStream.class, entity);
	...
	public void tearDownActivityStream() {
		try {
			if (connection != null) {
				connection.close();
			}
    ...
    /**
	 * 
	 *method to create the new testcase of testActivityStream
	 *	
	 */
	@Test(groups = "service", alwaysRun = true)
	public void testActivityStreamCreate() {
		ActivityStream actualObject = null;
		ActivityStream expectedObject = entity;
		...
		try {
			...
			for (Method method : methods) {
				if (method.getName().equals("findByPk")) {
					actualObject = (ActivityStream) 	serviceObj.findById(pk);
				}
			}
    ...
    /**
	 * 
	 *method to update testcase of testActivityStream
	 *	
	 */
	@Test(groups = "service", alwaysRun = true)
	public void testActivityStreamUpdate() {
		ActivityStream actualObject = null;
		ActivityStream expectedObject = entity;
		Long pk = entity.getId();
    ...
    /**
	 * 
	 *method to  delete the entity testcase of testActivityStream
	 *	
	 */
	@Test(groups = "service", alwaysRun = true)
	public void testActivityStreamDelete() {
		ActivityStream actualObject = null;
		ActivityStream expectedObject = null;
		Long pk = entity.getId();
    ...
    /**
	 * 
	 *method to  delete the entity testcase of testActivityStream  by primary key
	 *@throws Exception
	 */
	@Test(groups = "service", alwaysRun = true)
	public void testActivityStreamDeleteByPk() throws Exception {
		ActivityStream actualObject = null;
		ActivityStream expectedObject = null;
		Long pk = entity.getId();
    ...
    /**
	 * 
	 *method to  Find all the testcase of testActivityStream  
	 *
	 */
	@Test(groups = "service", alwaysRun = true)
	public void testActivityStreamFindAll() {
		ActivityStream actualObject = null;
		ActivityStream expectedObject = entity;
		Long pk = entity.getId();
    ...
    /**
	 * 
	 *method to  Find the testcase of testActivityStream by primarykey
	 *
	 */
	@Test(groups = "service", alwaysRun = true)
	public void testActivityStreamFindByPk() {
		ActivityStream actualObject = null;
		ActivityStream expectedObject = entity;
		Long pk = entity.getId();
	...
	@Autowired
	private IActivityStreamService serviceObj;
	private Method[] methods = null;
	private ActivityStream entity = new ActivityStream();
	...
	public static Logger logger = LoggerFactory
			.getLogger(TestActivityStreamServiceImpl.class);
}
