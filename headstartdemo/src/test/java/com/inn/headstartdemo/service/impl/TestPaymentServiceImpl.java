...
public class TestPaymentServiceImpl extends
		...
		try {
			...
			for (Method method : methods) {
				if (method.getName().equals("findByPk")) {
					actualObject = (Payment) 	serviceObj.findById(pk);
				}
			}
    ...
    /**
	 * 
	 *method to  Find the testcase of testPayment by primarykey
	 *
	 */
	@Test(groups = "service", alwaysRun = true)
	...
	@Autowired
	private IPaymentService serviceObj;
	...
	public static Logger logger = LoggerFactory
			.getLogger(TestPaymentServiceImpl.class);
}
