...
public class TestOrdersServiceImpl extends
		...
		try {
			...
			for (Method method : methods) {
				if (method.getName().equals("findByPk")) {
					actualObject = (Orders) 	serviceObj.findById(pk);
				}
			}
    ...
    /**
	 * 
	 *method to  Find the testcase of testOrders by primarykey
	 *
	 */
	@Test(groups = "service", alwaysRun = true)
	...
	@Autowired
	private IOrdersService serviceObj;
	...
	public static Logger logger = LoggerFactory
			.getLogger(TestOrdersServiceImpl.class);
}
