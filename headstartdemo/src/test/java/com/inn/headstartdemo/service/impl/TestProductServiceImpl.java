...
public class TestProductServiceImpl extends
		...
		try {
			...
			for (Method method : methods) {
				if (method.getName().equals("findByPk")) {
					actualObject = (Product) 	serviceObj.findById(pk);
				}
			}
    ...
    /**
	 * 
	 *method to  Find the testcase of testProduct by primarykey
	 *
	 */
	@Test(groups = "service", alwaysRun = true)
	...
	public static Logger logger = LoggerFactory
			.getLogger(TestProductServiceImpl.class);
}
