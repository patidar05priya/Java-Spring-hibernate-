...
public class TestUserConfigServiceImpl extends
    ...
    /**
	 * 
	 *method to create the new testcase of testUserConfig
	 *	
	 */
	@Test(groups = "service", alwaysRun = true)
	public void testUserConfigCreate() {
		UserConfig actualObject = null;
		UserConfig expectedObject = entity;
		...
		try {
			...
			for (Method method : methods) {
				if (method.getName().equals("findByPk")) {
					actualObject = (UserConfig) 	serviceObj.findById(pk);
				}
			}
    ...
    /**
	 * 
	 *method to update testcase of testUserConfig
	 *	
	 */
	@Test(groups = "service", alwaysRun = true)
    ...
    /**
	 * 
	 *method to  delete the entity testcase of testUserConfig
	 *	
	 */
	@Test(groups = "service", alwaysRun = true)
	public void testUserConfigDelete() {
		UserConfig actualObject = null;
		UserConfig expectedObject = null;
		Integer pk = entity.getId();
    ...
    /**
	 * 
	 *method to  delete the entity testcase of testUserConfig  by primary key
	 *@throws Exception
	 */
	@Test(groups = "service", alwaysRun = true)
	public void testUserConfigDeleteByPk() throws Exception {
		UserConfig actualObject = null;
		UserConfig expectedObject = null;
		Integer pk = entity.getId();
    ...
    /**
	 * 
	 *method to  Find all the testcase of testUserConfig  
	 *
	 */
	@Test(groups = "service", alwaysRun = true)
	public void testUserConfigFindAll() {
		UserConfig actualObject = null;
		UserConfig expectedObject = entity;
		Integer pk = entity.getId();
    ...
    /**
	 * 
	 *method to  Find the testcase of testUserConfig by primarykey
	 *
	 */
	@Test(groups = "service", alwaysRun = true)
	public void testUserConfigFindByPk() {
		UserConfig actualObject = null;
		UserConfig expectedObject = entity;
		Integer pk = entity.getId();
	...
	@Autowired
	private IUserConfigService serviceObj;
	...
	public static Logger logger = LoggerFactory
			.getLogger(TestUserConfigServiceImpl.class);
}
