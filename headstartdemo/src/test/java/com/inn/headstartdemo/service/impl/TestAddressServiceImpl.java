...
public class TestAddressServiceImpl extends
	...
	public void setUpAddress() {
		try {
			...
			entity = (Address) JPAUtils.getEntityObj(Address.class);
			Map<String, Map<String, Object>> dbUnitTableMap = JPAUtils
					.getDbUnitDefaultDataSet(Address.class, entity);
    ...
    /**
	 * 
	 *method to create the new testcase of testAddress
	 *	
	 */
	@Test(groups = "service", alwaysRun = true)
	public void testAddressCreate() {
		Address actualObject = null;
		Address expectedObject = entity;
		...
		try {
			...
			for (Method method : methods) {
				if (method.getName().equals("findByPk")) {
					actualObject = (Address) 	serviceObj.findById(pk);
				}
			}
    ...
    /**
	 * 
	 *method to update testcase of testAddress
	 *	
	 */
	@Test(groups = "service", alwaysRun = true)
    ...
    /**
	 * 
	 *method to  delete the entity testcase of testAddress
	 *	
	 */
	@Test(groups = "service", alwaysRun = true)
	public void testAddressDelete() {
		Address actualObject = null;
		Address expectedObject = null;
		Integer pk = entity.getId();
    ...
    /**
	 * 
	 *method to  delete the entity testcase of testAddress  by primary key
	 *@throws Exception
	 */
	@Test(groups = "service", alwaysRun = true)
	public void testAddressDeleteByPk() throws Exception {
		Address actualObject = null;
		Address expectedObject = null;
		Integer pk = entity.getId();
    ...
    /**
	 * 
	 *method to  Find all the testcase of testAddress  
	 *
	 */
	@Test(groups = "service", alwaysRun = true)
    ...
    /**
	 * 
	 *method to  Find the testcase of testAddress by primarykey
	 *
	 */
	@Test(groups = "service", alwaysRun = true)
	public void testAddressFindByPk() {
		Address actualObject = null;
		Address expectedObject = entity;
		Integer pk = entity.getId();
	...
	@Autowired
	private IAddressService serviceObj;
	private Method[] methods = null;
	private Address entity = new Address();
	...
	public static Logger logger = LoggerFactory
			.getLogger(TestAddressServiceImpl.class);
}
