...
public class TestAuditRestImpl extends AbstractTransactionalTestNGSpringContextTests {
	@BeforeClass
	...
	public void restAuditTestCaseRunner() {
		try {
			...
			for(TestSuite testSuite:project.getTestSuiteList())
			{
				...
				{	
					String entityId = String.valueOf(entity.getAuditId());
					...
					testCase.setPropertyValue("entityId", entity.getAuditId().toString());
	...
	private String xmlFileName = "TestAuditRestXML.xml";
	...
	public static Logger logger = LoggerFactory.getLogger(TestAuditRestImpl.class);
}
