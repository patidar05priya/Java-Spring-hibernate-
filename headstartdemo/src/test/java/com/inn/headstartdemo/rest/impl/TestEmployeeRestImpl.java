...
public class TestEmployeeRestImpl extends AbstractTransactionalTestNGSpringContextTests {
	@BeforeClass
	...
	public void restEmployeeTestCaseRunner() {
		try {
			...
			for(TestSuite testSuite:project.getTestSuiteList())
			{
				...
				{	
					String entityId = String.valueOf(entity.getEmployeeNumber());
					...
					testCase.setPropertyValue("entityId", entity.getEmployeeNumber().toString());
	...
	private String xmlFileName = "TestEmployeeRestXML.xml";
	...
	public static Logger logger = LoggerFactory.getLogger(TestEmployeeRestImpl.class);
}
