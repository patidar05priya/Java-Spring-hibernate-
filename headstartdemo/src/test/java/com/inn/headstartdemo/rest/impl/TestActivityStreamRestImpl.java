...
public class TestActivityStreamRestImpl extends AbstractTransactionalTestNGSpringContextTests {
	@BeforeClass
	...
	public void restActivityStreamTestCaseRunner() {
		try {
	...
	private String xmlFileName = "TestActivityStreamRestXML.xml";
	...
	public static Logger logger = LoggerFactory.getLogger(TestActivityStreamRestImpl.class);
}
