...
public class TestPaymentRestImpl extends AbstractTransactionalTestNGSpringContextTests {
	@BeforeClass
	...
	public void restPaymentTestCaseRunner() {
		try {
	...
	private String xmlFileName = "TestPaymentRestXML.xml";
	...
	public static Logger logger = LoggerFactory.getLogger(TestPaymentRestImpl.class);
}
