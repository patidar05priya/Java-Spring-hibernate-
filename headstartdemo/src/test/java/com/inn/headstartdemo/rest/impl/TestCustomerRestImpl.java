...
public class TestCustomerRestImpl extends AbstractTransactionalTestNGSpringContextTests {
	@BeforeClass
	...
	public void restCustomerTestCaseRunner() {
		try {
			...
			for(TestSuite testSuite:project.getTestSuiteList())
			{
				...
				{	
					String entityId = String.valueOf(entity.getCustomerNumber());
					...
					testCase.setPropertyValue("entityId", entity.getCustomerNumber().toString());
	...
	private String xmlFileName = "TestCustomerRestXML.xml";
	...
	public static Logger logger = LoggerFactory.getLogger(TestCustomerRestImpl.class);
}
