...
public class TestEmailNotificationsRestImpl extends AbstractTransactionalTestNGSpringContextTests {
	@BeforeClass
	...
	public void restEmailNotificationsTestCaseRunner() {
		try {
	...
	private String xmlFileName = "TestEmailNotificationsRestXML.xml";
	...
	public static Logger logger = LoggerFactory.getLogger(TestEmailNotificationsRestImpl.class);
}
