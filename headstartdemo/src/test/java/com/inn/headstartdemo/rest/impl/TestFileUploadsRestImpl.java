...
public class TestFileUploadsRestImpl extends AbstractTransactionalTestNGSpringContextTests {
	@BeforeClass
	...
	public void restFileUploadsTestCaseRunner() {
		try {
	...
	private String xmlFileName = "TestFileUploadsRestXML.xml";
	...
	public static Logger logger = LoggerFactory.getLogger(TestFileUploadsRestImpl.class);
}
