...
public class TestPermissionsRestImpl extends AbstractTransactionalTestNGSpringContextTests {
	@BeforeClass
	...
	public void restPermissionsTestCaseRunner() {
		try {
			...
			for(TestSuite testSuite:project.getTestSuiteList())
			{
				...
				{	
					String entityId = String.valueOf(entity.getPermissionid());
					...
					testCase.setPropertyValue("entityId", entity.getPermissionid().toString());
	...
	private String xmlFileName = "TestPermissionsRestXML.xml";
	...
	public static Logger logger = LoggerFactory.getLogger(TestPermissionsRestImpl.class);
}
