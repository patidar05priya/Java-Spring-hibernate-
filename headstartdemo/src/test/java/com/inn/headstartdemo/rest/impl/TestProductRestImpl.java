...
public class TestProductRestImpl extends AbstractTransactionalTestNGSpringContextTests {
	@BeforeClass
	...
	public void restProductTestCaseRunner() {
		try {
			...
			for(TestSuite testSuite:project.getTestSuiteList())
			{
				...
				{	
					String entityId = String.valueOf(entity.getProductCode());
					...
					testCase.setPropertyValue("entityId", entity.getProductCode().toString());
	...
	private String xmlFileName = "TestProductRestXML.xml";
	...
	public static Logger logger = LoggerFactory.getLogger(TestProductRestImpl.class);
}
