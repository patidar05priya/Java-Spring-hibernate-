...
public class TestUserConfigRestImpl extends AbstractTransactionalTestNGSpringContextTests {
	@BeforeClass
	...
	public void restUserConfigTestCaseRunner() {
		try {
	...
	private String xmlFileName = "TestUserConfigRestXML.xml";
	...
	public static Logger logger = LoggerFactory.getLogger(TestUserConfigRestImpl.class);
}
