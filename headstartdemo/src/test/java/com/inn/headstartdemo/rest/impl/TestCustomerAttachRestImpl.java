...
public class TestCustomerAttachRestImpl extends AbstractTransactionalTestNGSpringContextTests {
	@BeforeClass
	...
	public void restCustomerAttachTestCaseRunner() {
		try {
	...
	private String xmlFileName = "TestCustomerAttachRestXML.xml";
	...
	public static Logger logger = LoggerFactory.getLogger(TestCustomerAttachRestImpl.class);
}
