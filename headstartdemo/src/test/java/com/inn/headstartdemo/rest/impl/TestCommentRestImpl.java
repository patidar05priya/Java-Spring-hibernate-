...
public class TestCommentRestImpl extends AbstractTransactionalTestNGSpringContextTests {
	@BeforeClass
	...
	public void restCommentTestCaseRunner() {
		try {
	...
	private String xmlFileName = "TestCommentRestXML.xml";
	...
	public static Logger logger = LoggerFactory.getLogger(TestCommentRestImpl.class);
}
