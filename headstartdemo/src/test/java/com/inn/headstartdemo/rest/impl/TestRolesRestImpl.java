...
public class TestRolesRestImpl extends AbstractTransactionalTestNGSpringContextTests {
	@BeforeClass
	...
	public void restRolesTestCaseRunner() {
		try {
			...
			for(TestSuite testSuite:project.getTestSuiteList())
			{
				...
				{	
					String entityId = String.valueOf(entity.getRoleid());
					...
					testCase.setPropertyValue("entityId", entity.getRoleid().toString());
	...
	private String xmlFileName = "TestRolesRestXML.xml";
	...
	public static Logger logger = LoggerFactory.getLogger(TestRolesRestImpl.class);
}
