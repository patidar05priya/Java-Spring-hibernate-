...
public class TestUsersRestImpl extends AbstractTransactionalTestNGSpringContextTests {
	@BeforeClass
	...
	public void restUsersTestCaseRunner() {
		try {
			...
			for(TestSuite testSuite:project.getTestSuiteList())
			{
				...
				{	
					String entityId = String.valueOf(entity.getUserid());
					...
					testCase.setPropertyValue("entityId", entity.getUserid().toString());
	...
	private String xmlFileName = "TestUsersRestXML.xml";
	...
	public static Logger logger = LoggerFactory.getLogger(TestUsersRestImpl.class);
}
