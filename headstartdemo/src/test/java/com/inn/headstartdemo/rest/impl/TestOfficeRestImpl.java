...
public class TestOfficeRestImpl extends AbstractTransactionalTestNGSpringContextTests {
	@BeforeClass
	...
	public void restOfficeTestCaseRunner() {
		try {
			...
			for(TestSuite testSuite:project.getTestSuiteList())
			{
				...
				{	
					String entityId = String.valueOf(entity.getOfficeCode());
					...
					testCase.setPropertyValue("entityId", entity.getOfficeCode().toString());
	...
	private String xmlFileName = "TestOfficeRestXML.xml";
	...
	public static Logger logger = LoggerFactory.getLogger(TestOfficeRestImpl.class);
}
