...
public class TestAddressRestImpl extends AbstractTransactionalTestNGSpringContextTests {
	@BeforeClass
	...
	public void restAddressTestCaseRunner() {
		try {
	...
	private String xmlFileName = "TestAddressRestXML.xml";
	...
	public static Logger logger = LoggerFactory.getLogger(TestAddressRestImpl.class);
}
