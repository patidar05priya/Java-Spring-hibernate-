...
public class TestOrdersRestImpl extends AbstractTransactionalTestNGSpringContextTests {
	@BeforeClass
	...
	public void restOrdersTestCaseRunner() {
		try {
			...
			for(TestSuite testSuite:project.getTestSuiteList())
			{
				...
				{	
					String entityId = String.valueOf(entity.getOrderNumber());
					...
					testCase.setPropertyValue("entityId", entity.getOrderNumber().toString());
	...
	private String xmlFileName = "TestOrdersRestXML.xml";
	...
	public static Logger logger = LoggerFactory.getLogger(TestOrdersRestImpl.class);
}
