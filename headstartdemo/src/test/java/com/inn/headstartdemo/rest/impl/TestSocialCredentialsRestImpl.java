...
public class TestSocialCredentialsRestImpl extends AbstractTransactionalTestNGSpringContextTests {
	@BeforeClass
	...
	public void restSocialCredentialsTestCaseRunner() {
		try {
	...
	private String xmlFileName = "TestSocialCredentialsRestXML.xml";
	...
	public static Logger logger = LoggerFactory.getLogger(TestSocialCredentialsRestImpl.class);
}
