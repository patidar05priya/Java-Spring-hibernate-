...
public class TestActivityStreamDaoImpl extends
    ...
    /**
	 * 
	 *method to  Find the testcase of testActivityStream by rimarykey
	 *
	 */
	@Test(groups = "dao", alwaysRun = true)
	public void testActivityStreamFindByPk() {
		...
		try {
			...
			for (Method method : methods) {
				if (method.getName().equals("findByPk")) {
					actualObject = (ActivityStream) method.invoke(daoObj, pk);
				}
			}
	...
	@Autowired
	private IActivityStreamDao daoObj;
	...
	public static Logger logger = LoggerFactory
			.getLogger(TestActivityStreamDaoImpl.class);
}
