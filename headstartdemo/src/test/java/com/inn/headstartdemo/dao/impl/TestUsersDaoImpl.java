...
public class TestUsersDaoImpl extends
    ...
    /**
	 * 
	 *method to  Find the testcase of testUsers by rimarykey
	 *
	 */
	@Test(groups = "dao", alwaysRun = true)
	public void testUsersFindByPk() {
		...
		try {
			...
			for (Method method : methods) {
				if (method.getName().equals("findByPk")) {
					actualObject = (Users) method.invoke(daoObj, pk);
				}
			}
	...
	public static Logger logger = LoggerFactory
			.getLogger(TestUsersDaoImpl.class);
}
