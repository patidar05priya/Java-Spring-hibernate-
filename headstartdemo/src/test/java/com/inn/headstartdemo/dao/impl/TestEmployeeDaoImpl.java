...
public class TestEmployeeDaoImpl extends
	...
	public void setUpEmployee() {
		try {
			...
			entity = (Employee) JPAUtils.getEntityObj(Employee.class);
			Map<String, Map<String, Object>> dbUnitTableMap = JPAUtils
					.getDbUnitDefaultDataSet(Employee.class, entity);
    ...
    /**
	 * 
	 *method to create the new testcase of testEmployee
	 *	
	 */
	@Test(groups = "dao", alwaysRun = true)
	public void testEmployeeCreate() {
		Employee actualObject = null;
		Employee expectedObject = entity;
		Integer pk = entity.getEmployeeNumber();
	...
	/**
	 * 
	 *method to update testcase of testEmployee
	 *	
	 */
	@Test(groups = "dao", alwaysRun = true)
	...
	/**
	 * 
	 *method to  delete the entity testcase of testEmployee
	 *	
	 */
	@Test(groups = "dao", alwaysRun = true)
	public void testEmployeeDelete() {
		Employee actualObject = null;
		Employee expectedObject = null;
		Integer pk = entity.getEmployeeNumber();
	...
	/**
	 * 
	 *method to  delete the entity testcase of testEmployee  by primary key
	 *@throws Exception
	 */
	@Test(groups = "dao", alwaysRun = true)
	public void testEmployeeDeleteByPk() throws Exception {
		Employee actualObject = null;
		Employee expectedObject = null;
		Integer pk = entity.getEmployeeNumber();
    ...
    /**
	 * 
	 *method to  Find all the testcase of testEmployee  
	 *
	 */
	@Test(groups = "dao", alwaysRun = true)
    ...
    /**
	 * 
	 *method to  Find the testcase of testEmployee by rimarykey
	 *
	 */
	@Test(groups = "dao", alwaysRun = true)
	public void testEmployeeFindByPk() {
		Employee actualObject = null;
		Employee expectedObject = entity;
		Integer pk = entity.getEmployeeNumber();
		...
		try {
			...
			for (Method method : methods) {
				if (method.getName().equals("findByPk")) {
					actualObject = (Employee) method.invoke(daoObj, pk);
				}
			}
	...
	public static Logger logger = LoggerFactory
			.getLogger(TestEmployeeDaoImpl.class);
}
