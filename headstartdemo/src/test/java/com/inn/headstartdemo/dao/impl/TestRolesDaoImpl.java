...
public class TestRolesDaoImpl extends
    ...
    /**
	 * 
	 *method to  Find the testcase of testRoles by rimarykey
	 *
	 */
	@Test(groups = "dao", alwaysRun = true)
	public void testRolesFindByPk() {
		...
		try {
			...
			for (Method method : methods) {
				if (method.getName().equals("findByPk")) {
					actualObject = (Roles) method.invoke(daoObj, pk);
				}
			}
	...
	public static Logger logger = LoggerFactory
			.getLogger(TestRolesDaoImpl.class);
}
