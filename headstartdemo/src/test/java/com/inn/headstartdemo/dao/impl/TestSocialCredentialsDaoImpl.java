...
public class TestSocialCredentialsDaoImpl extends
    ...
    /**
	 * 
	 *method to  Find the testcase of testSocialCredentials by rimarykey
	 *
	 */
	@Test(groups = "dao", alwaysRun = true)
	public void testSocialCredentialsFindByPk() {
		...
		try {
			...
			for (Method method : methods) {
				if (method.getName().equals("findByPk")) {
					actualObject = (SocialCredentials) method.invoke(daoObj, pk);
				}
			}
	...
	@Autowired
	private ISocialCredentialsDao daoObj;
	...
	public static Logger logger = LoggerFactory
			.getLogger(TestSocialCredentialsDaoImpl.class);
}
