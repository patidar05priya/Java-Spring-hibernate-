...
public class TestFileUploadsDaoImpl extends
    ...
    /**
	 * 
	 *method to  Find the testcase of testFileUploads by rimarykey
	 *
	 */
	@Test(groups = "dao", alwaysRun = true)
	public void testFileUploadsFindByPk() {
		...
		try {
			...
			for (Method method : methods) {
				if (method.getName().equals("findByPk")) {
					actualObject = (FileUploads) method.invoke(daoObj, pk);
				}
			}
	...
	@Autowired
	private IFileUploadsDao daoObj;
	...
	public static Logger logger = LoggerFactory
			.getLogger(TestFileUploadsDaoImpl.class);
}
