...
public class TestProductDaoImpl extends
	...
	public void setUpProduct() {
		try {
			...
			entity = (Product) JPAUtils.getEntityObj(Product.class);
			Map<String, Map<String, Object>> dbUnitTableMap = JPAUtils
					.getDbUnitDefaultDataSet(Product.class, entity);
    ...
    /**
	 * 
	 *method to create the new testcase of testProduct
	 *	
	 */
	@Test(groups = "dao", alwaysRun = true)
	public void testProductCreate() {
		Product actualObject = null;
		Product expectedObject = entity;
		Integer pk = entity.getProductCode();
	...
	/**
	 * 
	 *method to update testcase of testProduct
	 *	
	 */
	@Test(groups = "dao", alwaysRun = true)
	...
	/**
	 * 
	 *method to  delete the entity testcase of testProduct
	 *	
	 */
	@Test(groups = "dao", alwaysRun = true)
	public void testProductDelete() {
		Product actualObject = null;
		Product expectedObject = null;
		Integer pk = entity.getProductCode();
	...
	/**
	 * 
	 *method to  delete the entity testcase of testProduct  by primary key
	 *@throws Exception
	 */
	@Test(groups = "dao", alwaysRun = true)
	public void testProductDeleteByPk() throws Exception {
		Product actualObject = null;
		Product expectedObject = null;
		Integer pk = entity.getProductCode();
    ...
    /**
	 * 
	 *method to  Find all the testcase of testProduct  
	 *
	 */
	@Test(groups = "dao", alwaysRun = true)
    ...
    /**
	 * 
	 *method to  Find the testcase of testProduct by rimarykey
	 *
	 */
	@Test(groups = "dao", alwaysRun = true)
	public void testProductFindByPk() {
		Product actualObject = null;
		Product expectedObject = entity;
		Integer pk = entity.getProductCode();
		...
		try {
			...
			for (Method method : methods) {
				if (method.getName().equals("findByPk")) {
					actualObject = (Product) method.invoke(daoObj, pk);
				}
			}
	...
	public static Logger logger = LoggerFactory
			.getLogger(TestProductDaoImpl.class);
}
