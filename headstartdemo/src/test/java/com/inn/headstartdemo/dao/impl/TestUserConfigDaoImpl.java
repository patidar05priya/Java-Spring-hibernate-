...
public class TestUserConfigDaoImpl extends
    ...
    /**
	 * 
	 *method to  Find the testcase of testUserConfig by rimarykey
	 *
	 */
	@Test(groups = "dao", alwaysRun = true)
	public void testUserConfigFindByPk() {
		...
		try {
			...
			for (Method method : methods) {
				if (method.getName().equals("findByPk")) {
					actualObject = (UserConfig) method.invoke(daoObj, pk);
				}
			}
	...
	public static Logger logger = LoggerFactory
			.getLogger(TestUserConfigDaoImpl.class);
}
