...
public class TestCustomerDaoImpl extends
    ...
    /**
	 * 
	 *method to  Find the testcase of testCustomer by rimarykey
	 *
	 */
	@Test(groups = "dao", alwaysRun = true)
	public void testCustomerFindByPk() {
		...
		try {
			...
			for (Method method : methods) {
				if (method.getName().equals("findByPk")) {
					actualObject = (Customer) method.invoke(daoObj, pk);
				}
			}
	...
	public static Logger logger = LoggerFactory
			.getLogger(TestCustomerDaoImpl.class);
}
