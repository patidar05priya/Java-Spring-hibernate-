...
public class TestCommentDaoImpl extends
    ...
    /**
	 * 
	 *method to  Find the testcase of testComment by rimarykey
	 *
	 */
	@Test(groups = "dao", alwaysRun = true)
	public void testCommentFindByPk() {
		...
		try {
			...
			for (Method method : methods) {
				if (method.getName().equals("findByPk")) {
					actualObject = (Comment) method.invoke(daoObj, pk);
				}
			}
	...
	public static Logger logger = LoggerFactory
			.getLogger(TestCommentDaoImpl.class);
}
