...
public class TestAddressDaoImpl extends
    ...
    /**
	 * 
	 *method to  Find the testcase of testAddress by rimarykey
	 *
	 */
	@Test(groups = "dao", alwaysRun = true)
	public void testAddressFindByPk() {
		...
		try {
			...
			for (Method method : methods) {
				if (method.getName().equals("findByPk")) {
					actualObject = (Address) method.invoke(daoObj, pk);
				}
			}
	...
	public static Logger logger = LoggerFactory
			.getLogger(TestAddressDaoImpl.class);
}
