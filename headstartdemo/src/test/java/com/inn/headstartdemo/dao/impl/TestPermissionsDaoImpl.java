...
public class TestPermissionsDaoImpl extends
    ...
    /**
	 * 
	 *method to  Find the testcase of testPermissions by rimarykey
	 *
	 */
	@Test(groups = "dao", alwaysRun = true)
	public void testPermissionsFindByPk() {
		...
		try {
			...
			for (Method method : methods) {
				if (method.getName().equals("findByPk")) {
					actualObject = (Permissions) method.invoke(daoObj, pk);
				}
			}
	...
	@Autowired
	private IPermissionsDao daoObj;
	...
	public static Logger logger = LoggerFactory
			.getLogger(TestPermissionsDaoImpl.class);
}
