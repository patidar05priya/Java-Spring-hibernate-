...
public class TestUsersDb extends
	...
	@Test(groups = "db", alwaysRun = true)
	public void testUsersDBFindByPk() {
		Object actualObject = null;
		Object expectedObject = null;
		ITable actualTable = null;
		ITable expectedTable = null;
	...
	@Test(groups = "db", alwaysRun = true)
	public void testUsersDBReferetial() {
		ITable actualTable = null;
	...
	public static Logger logger = LoggerFactory.getLogger(TestUsersDb.class);
}
