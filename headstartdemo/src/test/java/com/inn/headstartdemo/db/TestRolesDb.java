...
public class TestRolesDb extends
	...
	@Test(groups = "db", alwaysRun = true)
	public void testRolesDBFindByPk() {
		Object actualObject = null;
		Object expectedObject = null;
		ITable actualTable = null;
		ITable expectedTable = null;
	...
	@Test(groups = "db", alwaysRun = true)
	public void testRolesDBReferetial() {
		ITable actualTable = null;
	...
	public static Logger logger = LoggerFactory.getLogger(TestRolesDb.class);
}
