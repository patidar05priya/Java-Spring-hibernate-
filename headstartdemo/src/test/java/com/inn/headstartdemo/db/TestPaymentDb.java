...
public class TestPaymentDb extends
	...
	public void testPaymentDBCreate() {
	...
	@Test(groups = "db", alwaysRun = true)
	public void testPaymentDBFindByPk() {
		Object actualObject = null;
		Object expectedObject = null;
		ITable actualTable = null;
		ITable expectedTable = null;
	...
	@Test(groups = "db", alwaysRun = true)
	public void testPaymentDBUpdate() {
	...
	@Test(groups = "db", alwaysRun = true)
	public void testPaymentDBDelete() {
		int actualRows = 0;
		int expectedRows = 0;
	...
	@Test(groups = "db", alwaysRun = true)
	public void testPaymentDBReferetial() {
		ITable actualTable = null;
	...
	public static Logger logger = LoggerFactory.getLogger(TestPaymentDb.class);
}
