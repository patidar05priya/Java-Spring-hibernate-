...
public class TestEmailNotificationsDb extends
	...
	public void testEmailNotificationsDBCreate() {
	...
	@Test(groups = "db", alwaysRun = true)
	public void testEmailNotificationsDBFindByPk() {
		Object actualObject = null;
		Object expectedObject = null;
		ITable actualTable = null;
		ITable expectedTable = null;
	...
	@Test(groups = "db", alwaysRun = true)
	public void testEmailNotificationsDBUpdate() {
	...
	@Test(groups = "db", alwaysRun = true)
	public void testEmailNotificationsDBDelete() {
		int actualRows = 0;
		int expectedRows = 0;
	...
	@Test(groups = "db", alwaysRun = true)
	public void testEmailNotificationsDBReferetial() {
		ITable actualTable = null;
	...
	public static Logger logger = LoggerFactory.getLogger(TestEmailNotificationsDb.class);
}
