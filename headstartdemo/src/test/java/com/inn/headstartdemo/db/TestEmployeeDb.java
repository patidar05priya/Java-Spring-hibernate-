...
public class TestEmployeeDb extends
	...
	public void testEmployeeDBCreate() {
	...
	@Test(groups = "db", alwaysRun = true)
	public void testEmployeeDBFindByPk() {
		Object actualObject = null;
		Object expectedObject = null;
		ITable actualTable = null;
		ITable expectedTable = null;
	...
	@Test(groups = "db", alwaysRun = true)
	public void testEmployeeDBUpdate() {
	...
	@Test(groups = "db", alwaysRun = true)
	public void testEmployeeDBReferetial() {
		ITable actualTable = null;
	...
	public static Logger logger = LoggerFactory.getLogger(TestEmployeeDb.class);
}
