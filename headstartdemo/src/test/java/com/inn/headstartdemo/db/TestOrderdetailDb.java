...
public class TestOrderdetailDb extends
	...
	public void testOrderdetailDBCreate() {
	...
	@Test(groups = "db", alwaysRun = true)
	public void testOrderdetailDBFindByPk() {
		Object actualObject = null;
		Object expectedObject = null;
		ITable actualTable = null;
		ITable expectedTable = null;
	...
	@Test(groups = "db", alwaysRun = true)
	public void testOrderdetailDBUpdate() {
	...
	@Test(groups = "db", alwaysRun = true)
	public void testOrderdetailDBDelete() {
		int actualRows = 0;
		int expectedRows = 0;
	...
	@Test(groups = "db", alwaysRun = true)
	public void testOrderdetailDBReferetial() {
		ITable actualTable = null;
	...
	public static Logger logger = LoggerFactory.getLogger(TestOrderdetailDb.class);
}
