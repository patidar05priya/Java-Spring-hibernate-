...
public class TestOrdersDb extends
	...
	public void testOrdersDBCreate() {
	...
	@Test(groups = "db", alwaysRun = true)
	public void testOrdersDBFindByPk() {
		Object actualObject = null;
		Object expectedObject = null;
		ITable actualTable = null;
		ITable expectedTable = null;
	...
	@Test(groups = "db", alwaysRun = true)
	public void testOrdersDBUpdate() {
	...
	@Test(groups = "db", alwaysRun = true)
	public void testOrdersDBDelete() {
		int actualRows = 0;
		int expectedRows = 0;
	...
	@Test(groups = "db", alwaysRun = true)
	public void testOrdersDBReferetial() {
		ITable actualTable = null;
	...
	public static Logger logger = LoggerFactory.getLogger(TestOrdersDb.class);
}
