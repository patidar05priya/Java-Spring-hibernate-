...
public class TestSocialCredentialsDb extends
	...
	public void testSocialCredentialsDBCreate() {
	...
	@Test(groups = "db", alwaysRun = true)
	public void testSocialCredentialsDBFindByPk() {
		Object actualObject = null;
		Object expectedObject = null;
		ITable actualTable = null;
		ITable expectedTable = null;
	...
	@Test(groups = "db", alwaysRun = true)
	public void testSocialCredentialsDBUpdate() {
	...
	@Test(groups = "db", alwaysRun = true)
	public void testSocialCredentialsDBDelete() {
		int actualRows = 0;
		int expectedRows = 0;
	...
	@Test(groups = "db", alwaysRun = true)
	public void testSocialCredentialsDBReferetial() {
		ITable actualTable = null;
	...
	public static Logger logger = LoggerFactory.getLogger(TestSocialCredentialsDb.class);
}
