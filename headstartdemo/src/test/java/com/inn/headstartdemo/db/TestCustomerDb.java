...
public class TestCustomerDb extends
	...
	public void testCustomerDBCreate() {
	...
	@Test(groups = "db", alwaysRun = true)
	public void testCustomerDBFindByPk() {
		Object actualObject = null;
		Object expectedObject = null;
		ITable actualTable = null;
		ITable expectedTable = null;
	...
	@Test(groups = "db", alwaysRun = true)
	public void testCustomerDBUpdate() {
	...
	@Test(groups = "db", alwaysRun = true)
	public void testCustomerDBDelete() {
		int actualRows = 0;
		int expectedRows = 0;
	...
	@Test(groups = "db", alwaysRun = true)
	public void testCustomerDBReferetial() {
		ITable actualTable = null;
	...
	public static Logger logger = LoggerFactory.getLogger(TestCustomerDb.class);
}
