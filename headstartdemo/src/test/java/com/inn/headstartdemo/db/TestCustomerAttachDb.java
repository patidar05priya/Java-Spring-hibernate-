...
public class TestCustomerAttachDb extends
	...
	public void testCustomerAttachDBCreate() {
	...
	@Test(groups = "db", alwaysRun = true)
	public void testCustomerAttachDBFindByPk() {
		Object actualObject = null;
		Object expectedObject = null;
		ITable actualTable = null;
		ITable expectedTable = null;
	...
	@Test(groups = "db", alwaysRun = true)
	public void testCustomerAttachDBUpdate() {
	...
	@Test(groups = "db", alwaysRun = true)
	public void testCustomerAttachDBDelete() {
		int actualRows = 0;
		int expectedRows = 0;
	...
	@Test(groups = "db", alwaysRun = true)
	public void testCustomerAttachDBReferetial() {
		ITable actualTable = null;
	...
	public static Logger logger = LoggerFactory.getLogger(TestCustomerAttachDb.class);
}
