...
public class TestAuditDb extends
	...
	@Test(groups = "db", alwaysRun = true)
	public void testAuditDBFindByPk() {
		Object actualObject = null;
		Object expectedObject = null;
		ITable actualTable = null;
		ITable expectedTable = null;
	...
	@Test(groups = "db", alwaysRun = true)
	public void testAuditDBReferetial() {
		ITable actualTable = null;
	...
	public static Logger logger = LoggerFactory.getLogger(TestAuditDb.class);
}
