...
public class TestCommentDb extends
	...
	public void testCommentDBCreate() {
	...
	@Test(groups = "db", alwaysRun = true)
	public void testCommentDBFindByPk() {
		Object actualObject = null;
		Object expectedObject = null;
		ITable actualTable = null;
		ITable expectedTable = null;
	...
	@Test(groups = "db", alwaysRun = true)
	public void testCommentDBUpdate() {
	...
	@Test(groups = "db", alwaysRun = true)
	public void testCommentDBDelete() {
		int actualRows = 0;
		int expectedRows = 0;
	...
	@Test(groups = "db", alwaysRun = true)
	public void testCommentDBReferetial() {
		ITable actualTable = null;
	...
	public static Logger logger = LoggerFactory.getLogger(TestCommentDb.class);
}
