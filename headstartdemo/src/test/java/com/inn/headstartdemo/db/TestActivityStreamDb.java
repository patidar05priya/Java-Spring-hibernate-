...
public class TestActivityStreamDb extends
	...
	public void testActivityStreamDBCreate() {
	...
	@Test(groups = "db", alwaysRun = true)
	public void testActivityStreamDBFindByPk() {
		Object actualObject = null;
		Object expectedObject = null;
		ITable actualTable = null;
		ITable expectedTable = null;
	...
	@Test(groups = "db", alwaysRun = true)
	public void testActivityStreamDBUpdate() {
	...
	@Test(groups = "db", alwaysRun = true)
	public void testActivityStreamDBDelete() {
		int actualRows = 0;
		int expectedRows = 0;
	...
	@Test(groups = "db", alwaysRun = true)
	public void testActivityStreamDBReferetial() {
		ITable actualTable = null;
	...
	public static Logger logger = LoggerFactory.getLogger(TestActivityStreamDb.class);
}
