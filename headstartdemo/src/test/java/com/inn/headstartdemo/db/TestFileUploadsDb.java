...
public class TestFileUploadsDb extends
	...
	public void testFileUploadsDBCreate() {
	...
	@Test(groups = "db", alwaysRun = true)
	public void testFileUploadsDBFindByPk() {
		Object actualObject = null;
		Object expectedObject = null;
		ITable actualTable = null;
		ITable expectedTable = null;
	...
	@Test(groups = "db", alwaysRun = true)
	public void testFileUploadsDBUpdate() {
	...
	@Test(groups = "db", alwaysRun = true)
	public void testFileUploadsDBDelete() {
		int actualRows = 0;
		int expectedRows = 0;
	...
	@Test(groups = "db", alwaysRun = true)
	public void testFileUploadsDBReferetial() {
		ITable actualTable = null;
	...
	public static Logger logger = LoggerFactory.getLogger(TestFileUploadsDb.class);
}
