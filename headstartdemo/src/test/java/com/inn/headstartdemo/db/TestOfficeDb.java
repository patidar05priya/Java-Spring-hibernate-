...
public class TestOfficeDb extends
	...
	public void testOfficeDBCreate() {
	...
	@Test(groups = "db", alwaysRun = true)
	public void testOfficeDBFindByPk() {
		Object actualObject = null;
		Object expectedObject = null;
		ITable actualTable = null;
		ITable expectedTable = null;
	...
	@Test(groups = "db", alwaysRun = true)
	public void testOfficeDBUpdate() {
	...
	@Test(groups = "db", alwaysRun = true)
	public void testOfficeDBDelete() {
		int actualRows = 0;
		int expectedRows = 0;
	...
	@Test(groups = "db", alwaysRun = true)
	public void testOfficeDBReferetial() {
		ITable actualTable = null;
	...
	public static Logger logger = LoggerFactory.getLogger(TestOfficeDb.class);
}
