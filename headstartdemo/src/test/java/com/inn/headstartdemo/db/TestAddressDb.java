...
public class TestAddressDb extends
	...
	public void testAddressDBCreate() {
	...
	@Test(groups = "db", alwaysRun = true)
	public void testAddressDBFindByPk() {
		Object actualObject = null;
		Object expectedObject = null;
		ITable actualTable = null;
		ITable expectedTable = null;
	...
	@Test(groups = "db", alwaysRun = true)
	public void testAddressDBUpdate() {
	...
	@Test(groups = "db", alwaysRun = true)
	public void testAddressDBDelete() {
		int actualRows = 0;
		int expectedRows = 0;
	...
	@Test(groups = "db", alwaysRun = true)
	public void testAddressDBReferetial() {
		ITable actualTable = null;
	...
	public static Logger logger = LoggerFactory.getLogger(TestAddressDb.class);
}
