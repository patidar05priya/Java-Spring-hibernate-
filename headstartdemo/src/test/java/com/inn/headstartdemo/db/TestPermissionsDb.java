...
public class TestPermissionsDb extends
	...
	public void testPermissionsDBCreate() {
	...
	@Test(groups = "db", alwaysRun = true)
	public void testPermissionsDBFindByPk() {
		Object actualObject = null;
		Object expectedObject = null;
		ITable actualTable = null;
		ITable expectedTable = null;
	...
	@Test(groups = "db", alwaysRun = true)
	public void testPermissionsDBUpdate() {
	...
	@Test(groups = "db", alwaysRun = true)
	public void testPermissionsDBDelete() {
		int actualRows = 0;
		int expectedRows = 0;
	...
	@Test(groups = "db", alwaysRun = true)
	public void testPermissionsDBReferetial() {
		ITable actualTable = null;
	...
	public static Logger logger = LoggerFactory.getLogger(TestPermissionsDb.class);
}
