...
!function ($) {
        ...
        var DRPTemplate = '<div class="daterangepicker dropdown-menu">' +
                ...
                '<div class="ranges">' +
                  '<div class="range_inputs">' +
                    ...
                    '</div>' +
                    '<button class="applyBtn btn-info" disabled="disabled"></button>&nbsp;' +
                    '<button class="cancelBtn btn-info"></button>' +
                  '</div>' +
                '</div>' +
              '</div>';
    ...
    DateRangePicker.prototype = {
        ...
        setOptions: function(options, callback) {
            ...
            this.applyClass = 'width-40';
            // this.cancelClass = 'btn-default';
            this.cancelClass = 'btn-info';
            this.cancelClass = 'width-50';
