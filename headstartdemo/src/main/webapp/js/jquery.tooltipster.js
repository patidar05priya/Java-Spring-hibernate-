		...
		init: function() {		
			...
			if (run == true) {
				...
				if ((this.options.iconDesktop == true) && (!touchDevice) || ((this.options.iconTouch == true) && (touchDevice))) {
					var transferContent = $this.text();					
					//alert(transferContent);
				...
				var tooltipsterContent = $.trim(object.options.content).length > 0 ? object.options.content : $this.text();
				//alert(tooltipsterContent);
