			...
			while(j<len){
				...
				if( $(ind).hasClass('jqgrow') ) {
					...
					$('td[role="gridcell"]',ind).each( function(i) {
						...
						if ( nm !== 'cb' && nm !== 'subgrid' && nm !== 'rn' &&  nm!= 'actions' && nm!= 'actions_inline') {
							if($t.p.treeGrid===true && nm === $t.p.ExpandColumn) {
                               ...
                               if($t.p.colModel[i].edittype != "select"){
									res[nm] = $.unformat.call($t,this,{rowId:ind.id, colModel:$t.p.colModel[i]},i);
									
								}
								else{
									
									var data =$t.p.colModel[i].index;
									data=data.split(".");
									
									//nm=""+data[0]+"&rdquo;:{&rdquo;"+data[1]+"";
									nm=""+data[0]+":{"+data[1]+"";
									//alert($.unformat.call($t,this,{rowId:ind.id, colModel:$t.p.colModel[i]},i));
									res[nm] = $.unformat.call($t,this,{rowId:ind.id, colModel:$t.p.colModel[i]},i)+"!@#$%^&";
...
(function (a) {
    ...
    a.fn.fmatter.actions = function (c, b) {
        ...
        f += "<div title='" + a.jgrid.edit.bSubmit + "' style='float:left;display:none' class='ui-pg-div ui-inline-save' " +
            ("id='jSaveButton_" + e + "' onclick=customInlineCall('"+ e + "','"+tableId+"'); onmouseover=jQuery(this).addClass('ui-state-hover'); onmouseout=jQuery(this).removeClass('ui-state-hover'); ") + "><span class='ui-icon ui-icon-disk'></span></div>";
        f += "<div title='" + a.jgrid.edit.bCancel + "' style='float:left;display:none;margin-left:5px;' class='ui-pg-div ui-inline-cancel' " + ("id='jCancelButton_" + e + "' onclick=customHideColoumn('"+ e + "','"+tableId+"'); onmouseover=jQuery(this).addClass('ui-state-hover'); onmouseout=jQuery(this).removeClass('ui-state-hover'); ") +
   ...
   $.unformat = function (cellval,options,pos,cnt) {
		...
		myeditType = options.colModel.edittype,
		...
		} else if((formatType !== undefined && $.fmatter.isString(formatType)) || myeditType == "select" ) {
			
			var opts = $.jgrid.formatter || {}, stripTag;
			switch(formatType || myeditType ) {
				case 'integer' :
				...
				case 'select' :
					...
					ret = a.unformat.select(cellval,options,pos,cnt);
					break;
				case 'actions':
					return "";
				default:
...
(function (a) {
    a.extend(a.jgrid, {
        ...
        hideModal: function (d, b) {
            ...
            if (b.onClose) {
                var c = b.gb && "string" === typeof b.gb && "#gbox_" === b.gb.substr(0, 6) ? b.onClose(a("#" + b.gb.substr(6))[0], d) : b.onClose(d);
    ...
    a.jgrid.extend({
        ...
        saveRow: function (c, b, e, o, l, g, n) {
            ...
            if ("1" === h) {
                ...
                } else a("#lui_" + a.jgrid.jqID(d.p.id)).show(), r = a.extend({}, i, r), r[p] = a.jgrid.stripPref(d.p.idPrefix, r[p]), a.
