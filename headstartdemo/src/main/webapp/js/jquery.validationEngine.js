 ...
 */
 (function($) {
	 ...
	 var methods = {
		...
		*/
		_validateField: function(field, options, skipAjaxValidation) {
			...
			/* Custom for NEW UI bug fix*/
			if(options.maxErrorsPerField == false || options.maxErrorsPerField == "false") {
				options.maxErrorsPerField = 1;
			}
	...
	$.validationEngine= {fieldIdCounter: 0,defaults:{
		...
		scroll: false, /* previously true for fixing defect */
