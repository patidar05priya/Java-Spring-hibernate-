...
(function () {
        ...
        CKEDITOR.lang = {
            ...
            load: function (a, e, b) {
                if (!a || !CKEDITOR.lang.languages[a]) a = this.detect(e,
                    a);
                this[a] ? b(a, this[a]) : CKEDITOR.scriptLoader.load(CKEDITOR.getUrl("../js/" + a + ".js"), function () {
    ...
    (function () {
        function a() {
            return CKEDITOR.getUrl(CKEDITOR.skinName.split(",")[1] || "../styles/" + CKEDITOR.skinName.split(",")[0] + "/")
        }
...
*/
    ...
    CKEDITOR.config.menu_groups = "clipboard,form,tablecell,tablecellproperties,tablerow,tablecolumn,anchor,link,image,checkbox,radio,textfield,hiddenfield,imagebutton,button,select,textarea,div";
    ...
    CKEDITOR.config.contentsCss = "../styles/contents.css";
    (function () {
        function e(b, a) {
    ...
    CKEDITOR.config.plugins = 'dialogui,dialog,about,a11yhelp,dialogadvtab,basicstyles,blockquote,button,panelbutton,panel,floatpanel,colorbutton,colordialog,templates,menu,contextmenu,resize,toolbar,elementspath,enterkey,entities,popup,filebrowser,find,fakeobjects,floatingspace,listblock,richcombo,font,forms,format,htmlwriter,wysiwygarea,image,indent,indentblock,indentlist,justify,menubutton,link,list,liststyle,magicline,maximize,preview,print,showblocks,showborders,sourcearea,scayt,tab,table,tabletools,undo,wsc';
