...
qq.obj2url = function(obj, temp, prefixDone){
    ...
    if (!prefixDone && temp) {
        if(BrowserDetect.browser == "Explorer" || BrowserDetect.browser == "Mozilla" /* For IE 11 */){
			prefix = (/\?/.test(temp)) ? (/\?$/.test(temp)) ? '' : '&' : '?filename=';
		}else{
    ...
    if (temp) {
		return uristrings.join(prefix).replace("filedata=","");
    } else {
...
qq.FileUploader = function(o){
    ...
    qq.extend(this._options, {
        ...
        template: '<div class="qq-uploader">' +
            ...
            (!this._dragbg? '<div class="qq-uploaderbg"><div class="marginB10">Drop files here</div> <div class="smlFont-grey marginB10">Or</div> </div>' : '') +
            (!this._options.button ? '<div align="center"><div class="qq-upload-button">{uploadButtonText}</div></div>' : '') +
        ...
        fileTemplate: '<li>' +
            ...
            '<span class="qq-upload-file left"></span>' +
            '<span class="qq-upload-size"></span>' +
            '<a class="qq-upload-cancel fltrt" href="#">&nbsp;&nbsp;<img class="valign" src="../images/note_deletebut.png" style="height: 10px;"/></a>' +
...
qq.extend(qq.FileUploader.prototype, {
    ...
    _onComplete: function(id, fileName, result){
        ...
        if (result == undefined){
            ...
            this._controlFailureTextDisplay(item, 'ram jane');//was not here initially
        }
    },
    _onUpload: function(id, fileName, xhr){
        ...
        responseProperty = this._options.failedUploadTextDisplay.responseProperty;
		 if (mode === 'custom') {
            ...
            if (failureReason) {
                ...
                qq.setText(this._find(item, 'failText'), "rohit");
...
qq.extend(qq.UploadHandlerForm.prototype, {
    ...
    _createForm: function(iframe, params){
        ...
        form.setAttribute('action', queryString+"&csrfParam="+getCookieClosePortal());
...
qq.extend(qq.UploadHandlerXhr.prototype, {
    ...
    _upload: function(id, params){
        ...
        /*this is specific handling to send file name as a query param*/
		queryString = replaceAll("?",queryString,"?filename=");
        ...
        xhr.setRequestHeader("csrfParam", getCookieClosePortal());
